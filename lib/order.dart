...
import 'package:danastoreadminpanel/address.dart';
import 'package:danastoreadminpanel/features/shop/models/cart_item_model.dart';
...
factory OrderModel.fromSnapshot(DocumentSnapshot snapshot) {
  ...
  return OrderModel(
    ...
    totalAmount: (data['totalAmount'] as num).toDouble(), // Ensures double type
